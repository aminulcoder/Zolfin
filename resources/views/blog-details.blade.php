                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 text-center">
                        ...
                        >
                            ...
                            <li class="breadcrumbs__list">
                                <a
                                    href="{{ route('single-post', $data->slug) }}"
                                    class="t-link breadcrumbs__link t-link--light-alpha text-capitalize"
                                >
                                    {{ $data->title }}
                                </a>
                                    ...
                                    <div class="blog-post__body">
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    <a href="/users/{{ $data->user->username }}" class="t-link blog-post__author d-flex align-items-center">
                                                        <span class="blog-post__author-img t-mr-8">
                                                            <img src="{{ $data->user->photo }}" alt="{{ $data->user->name }}" class="img-fluid">
                                                        </span>
                                                ...
                                                >
                                                    ...
                                                    >
                                                        ...
                                                        ></i>
                                                        {{ date('d F', strtotime( $data->created_at )) }}
                                                    </a>
                                                </li>
                                                <li
                                                    class="blog-post__footer-list t-mb-15 t-mr-15"
